...
%
\def\texinfoversion{2005-05-19.14}
%
...
\ifx\putwordDefpar\undefined    \gdef\putwordDefpar{Parameter}\fi
\ifx\putwordDeftypepar\undefined\gdef\putwordDeftypepar{Parameter}\fi
...
\def\noinexample{\begingroup \def\Enoinexample{\nonfillfinish\endgroup}\noinlisp}
...
\def\deftypevrheader #1#2#3#4{\dovarind#3 \relax%
\begingroup\defname {\defheaderxcond#2\relax$.$#3 \code{#4}}{#1}
  \defargscommonending
\endgroup}
